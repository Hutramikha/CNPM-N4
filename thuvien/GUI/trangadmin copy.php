...
<body>
        ...
        <div class="homecontent">
            ...
            <div class="quanlysach">
                ...
                <div class="input_contain">
                    ...
                    <div class="image-container">
                        <div class="image-preview"><img id="image_max" class="image-sach" src="../img/noimages.png" alt="">
                        </div>
                ...
                <div class="table_contain">
                    ...
                    <div style="display: flex; justify-content: center;">
                        ...
                        <div class="table_limit-3h" style="width: 65%; margin-left: 0.7%; max-height: 24.5vh;">
            ...
            <div class="quanlynhanvien">
                ...
                <div class="input_contain">
                    ...
                    <div class="image-container">
                        <div class="image-preview"><img id="image_max" class="image-nv" src="../img/noimages.png" alt="">
                        </div>
            ...
            <div class="quanlydocgia">
                ...
                <div class="input_contain">
                    ...
                    <div class="image-container">
                        <div class="image-preview"><img id="image_max" class="image-dg" src="../img/noimages.png" alt="">
                        </div>
            ...
            <div class="quanlytrasach">
                ...
                <div class="button_contain">
                    <button class="btn_action btn-add btn-add-ct-phieu_tra">Thêm chi tiết</button>
                    <!-- <button class="btn_action btn-edit btn-edit-dg">Sửa</button>
                    <button class="btn_action btn-delete btn-delete-dg">Xóa</button>
                    <button class="btn_action btn-save btn-save-dg" disabled>Lưu</button>
                    <button class="btn_action btn-cancel btn-cancel-dg" disabled>Hủy</button> -->
                ...
                <div class="input_contain">
                    <div class="input_contain_child">
                        <div class="input-group">
                            ...
                            <input type="text" class="input-control" placeholder="Mã chi tiết sách">
                        </div>
                        <div class="input-group">
                            <label class="input-label">Mã phiếu mượn:</label>
                            <input type="text" class="input-control" placeholder="Mã phiếu mượn">
                        </div>
                    </div>
                    <div class="input_contain_child">
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="input-control" placeholder="Vị trí sách">
                        </div>
                    </div>
                    <div class="input_contain_child">
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="input-control" placeholder="VNĐ">
                        </div>
                    </div>
                </div>
                <div class="table_contain">
                ...
                <div class="table_contain">
                    <div class="table_limit-3h" style="margin-bottom: 2%; max-height: 28.2vh;">
                        <table class="table-ct-sach_tra">
                            <thead>
                                <tr>
                                    <th colspan="7" class="table-title">Chi Tiết Sách Trả</th>
                                </tr>
                                <tr>
                                    <th class="table_stt">STT</th>
                                    <th>Mã vạch</th>
                    ...
                    <div style="display: flex; justify-content: center;">
                        <div class="table_limit-3h" style="width: 60%; max-height: 24.5vh;">
                            <table class="table-phieu_tra">
                                <thead>
                                    <tr>
                                        <th colspan="6" class="table-title">Danh Sách Phiếu Trả</th>
                                    </tr>
                                    <tr>
                                        <th>Mã phiếu trả</th>
                                        <th>Ngày trả</th>
                            ...
                            <div class="navigate-pro-form"
                             ...
                             background-color: rgba(0, 0, 0, 0.5); z-index: 2;transition: opacity 0.3s ease;"></div>
                                <div class="addpro-input"
                                    ...
                                    <input type="text" id="input-tenncc" name="input-tenncc" placeholder="Nhập tên nhà cung cấp" required
                                        style="margin-bottom: 10px;">

                                    <label>Số điện thoại:</label>
                                    <input type="text" id="input-sdtncc" name="input-sdtncc" placeholder="Nhập số điện thoại" required>

                                    <label>Nhập địa chỉ:</label>
                                    <input type="text" id="input-dcncc" name="input-dcncc" placeholder="Nhập địa chỉ" required>

                                    <div>
                                        <button type="submit" class="addprosubmit"
                                            style="margin: 10px 0 0 30px; width: 50px; border-radius: 5px; background-color: greenyellow">Thêm</button>
                                ...
                                <div class="search-pro-div"
                                    ...
                                    <input class="search-pro" type="text" placeholder="Tìm kiếm nhà cung cấp"
                                ...
                                <button type="button" class="bx bx-refresh" id="refresh"
                                    style="width: 30px;border-radius:50px;background-color:graytext; margin-left: 5px"></button>
    ...
    <script src="../Controller/ql_phieumuon.js"></script>
    <script src="../Controller/ql_phieutra.js"></script>
    <script src="../Controller/ql_taikhoan.js"></script>
